...
// HTTP Output Buffer Size  这在恨了吧，一下给1K内存
...
//-------------------------------------------------------
    ...
    #define httpd_strlen(s)        os_strlen(s)
    #define httpd_strchr(s,c)      os_strchr(s,c)
    #define httpd_strrchr(s,c)     jm_strrchr(s,c) //os_strrchr(s,c)
    #define httpd_strnicmp(a,b,c)  jm_strncasecmp(a,b,c) //os_strncasecmp(a,b,c)
    #define httpd_stricmp(a,b)     jm_strcasecmp(a,b) //os_strcasecmp(a,b)
    #define httpd_strcpy(a,b)      os_strcpy(a,b)
    #define httpd_strncpy(a,b,c)   os_strncpy(a,b,c)
    #define httpd_strcat(a,b)      os_strcat(a,b)
