...
#define JM_NOW_KEY_WID "wid"

#define JM_NOW_KEY_FN "_fn"
#define JM_NOW_KEY_MA "_ma"
#define JM_NOW_KEY_MAS "_mas"
#define JM_NOW_KEY_ID "_id"
...
#define CTRL_FUNC_TYPE_GPIO 1 // GPIO操作
#define CTRL_FUNC_TYPE_SYS_CONFIG 2 //系统配置
#define CTRL_FUNC_TYPE_SYS_QRY 3 //系统信息查询
#define CTRL_FUNC_TYPE_SYS_OP 4 //系统操作
#define CTRL_FUNC_TYPE_FORWARD 5 //数据转发
...
typedef enum _DeviceRole {
	DevRoleSlave=0,//从设备，可通过主设备控制从设备
	DevRoleMaster=1,//主设备，可以通过主设备控制从设备
	DevRoleStandalone=2,//独立设备，独立存在设备，不可以加入主设备，也不可以控制其他设备
